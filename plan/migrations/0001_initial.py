...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'plan_plan', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')(default='Default Plan', max_length=50)),
            ('rate', self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=6, decimal_places=2)),
            ('domain_limit', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('form_limit', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('message_limit', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('selectable', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'plan', ['Plan'])

        # Adding model 'UserPlan'
        db.create_table(u'plan_userplan', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='Default Plan', max_length=50)),
            ('rate', self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=6, decimal_places=2)),
            ('domain_limit', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('form_limit', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('message_limit', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='plan', unique=True, to=orm['account.User'])),
        ))
        db.send_create_signal(u'plan', ['UserPlan'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'plan_userplan')
