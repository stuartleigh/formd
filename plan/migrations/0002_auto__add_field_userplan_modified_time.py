...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserPlan.modified_time'
        db.add_column(u'plan_userplan', 'modified_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 15, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserPlan.modified_time'
        db.delete_column(u'plan_userplan', 'modified_time')
