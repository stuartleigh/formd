...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserPlan.key'
        db.add_column(u'plan_userplan', 'key',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=75),
                      keep_default=False)

        # Adding field 'Plan.key'
        db.add_column(u'plan_plan', 'key',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=75),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserPlan.key'
        db.delete_column(u'plan_userplan', 'key')

        # Deleting field 'Plan.key'
        db.delete_column(u'plan_plan', 'key')
